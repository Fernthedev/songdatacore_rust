...
impl RustCStringWrapper {
    ...
    #[no_mangle]
    pub extern fn c_new(c_str: *mut c_char) -> RustCStringWrapper {
        unsafe {
            RustCStringWrapper {
...
impl BeatStarDataFile {
    map_extern!(songs, RustCStringWrapper, BeatStarSong, extern_map_songs_get, extern_map_songs_len, extern_map_songs_get_key);
}
...
impl BeatStarSong {
    ...
    vec_extern!(diffs, BeatStarSongDifficultyStats, extern_vec_diffs_get, extern_vec_diffs_len);
    ...
    #[no_mangle]
    pub extern fn get_characteristics_len(&self, beat_char: &BeatStarCharacteristics) -> usize {
    ...
    #[no_mangle]
    pub extern fn get_characteristics_str(&self, beat_char: &BeatStarCharacteristics, index: usize) -> *const c_char {
        return match self.characteristics.get(beat_char) {
            None => {ptr::null()}
            Some(e) => {
    ...
    #[no_mangle]
    pub extern fn get_characteristic_stats(&self, beat_char: &BeatStarCharacteristics, beat_key2: *mut c_char) -> *const BeatStarSongDifficultyStats {
        return match self.characteristics.get(beat_char) {
